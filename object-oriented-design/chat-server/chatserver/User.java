 ...
 * File: User.java
 * ---------------
 * A user of the chat server application.
 **/
package chatserver;
...
public class User {
    ...
    public void receivedAddRequest(AddRequest req) {
        ...
        if (!receivedAddRequests.containsKey(senderId)) {
            receiveAddRequests.put(senderId, req);
        }
    }
    ...
    public void addConversation(PrivateChat conversation) {
        ...
        privateChats.put(otherUser.getId(), conversattion);
    }
